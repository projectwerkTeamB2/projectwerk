 ...
 public   class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Strip myTestStrip = new Strip(3687, "fruitcake", 999, auteurs, mytestreeks, myTestuitgeverij, true);
            ...
            Console.WriteLine(myTestStrip.IsEenLosseStrip);
            Console.WriteLine(myTestStrip2.IsEenLosseStrip);
        }
    }
}
